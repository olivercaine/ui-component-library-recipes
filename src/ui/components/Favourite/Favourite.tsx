...
export const Favourite: FC<{
  ...
  */
  ...
  value,
    ...
    return (
      <button onClick={onClickHandler} className={`rounded-full w-10 h-10 p-0 border-0 inline-flex items-center justify-center text-gray-500 ${css} ${checked ? 'bg-red-200' : 'bg-gray-200'}`}>
