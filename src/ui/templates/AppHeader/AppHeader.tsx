  ...
  <header className='white-neutral-50 bg-dark-grey body-font' data-testid='AppHeader'>
    <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
      <a className='flex title-font font-medium items-center mb-4 md:mb-0' href={window.location.pathname}>
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' stroke='currentColor' strokeLinecap='round' viewBox='0 0 24 24'
          strokeLinejoin='round' stroke-width='2' className='w-10 h-10 text-white p-2 bg-indigo-500 rounded-full'>
