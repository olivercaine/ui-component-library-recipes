...
const maybeReactUseId$1 = React__namespace['useId' + ''];
/**
 *
...
var StarBorder = createSvgIcon( /*#__PURE__*/jsxRuntime.jsx("path", {
...
function IconContainer(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  if (readOnly) {
    return /*#__PURE__*/jsxRuntime.jsx("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
...
const defaultIcon = /*#__PURE__*/jsxRuntime.jsx(Star, {
  fontSize: "inherit"
});
const defaultEmptyIcon = /*#__PURE__*/jsxRuntime.jsx(StarBorder, {
  fontSize: "inherit"
});
...
const Rating = /*#__PURE__*/React__namespace.forwardRef(function Rating(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(RatingRoot, _extends({
    ref: handleRef,
      ...
      if (precision < 1) {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(RatingDecimal, {
          ...
          children: items.map(($, indexDecimal) => {
            ...
            return /*#__PURE__*/jsxRuntime.jsx(RatingItem, _extends({}, ratingItemProps, {
...
var SlotContext = React__default["default"].createContext(null);
function useSlotProps(props, defaultSlot) {
  var slot = props.slot || defaultSlot;

  var _ref = React.useContext(SlotContext) || {},
      _ref$slot = _ref[slot],
...
function SlotProvider(props) {
  var parentSlots = React.useContext(SlotContext) || {};
  ...
  return React__default["default"].createElement(SlotContext.Provider, {
    value: value
  }, children);
}
function ClearSlots(props) {
  ...
  var content = React__default["default"].Children.toArray(children).length <= 1 && typeof children === 'function' ? React__default["default"].cloneElement(React__default["default"].Children.only(children), otherProps) : children;
  return React__default["default"].createElement(SlotContext.Provider, {
    value: {}
  }, content);
}
var containsChild = function containsChild(children, type) {
  return React__default["default"].Children.toArray(children).some(function (child) {
    var _child$type;
...
var EzHeading = React.forwardRef(function (_ref, ref) {
  ...
  var headingElement = React__default["default"].createElement(HeadingLevel, {
    className: headingCss({
      size: size,
      casing: casing,
      color: color
    })
  }, React__default["default"].createElement(ClearSlots, null, title));
  var subheadingElement = subtitle && (size === '3' || size === '5') && React__default["default"].createElement("div", {
    className: subheadingCss()
  }, React__default["default"].createElement(ClearSlots, null, subtitle));
  var wrapperElement = React__default["default"].createElement("div", null, headingElement, subheadingElement);
  var el = subheadingElement ? wrapperElement : headingElement;
  var props = domProps(slotProps, alignCss({
    align: align
  }));
  return React__default["default"].cloneElement(el, mergeProps(props, additionalProps, {
    ref: ref,
...
var useOnFocusOutside = function useOnFocusOutside(handler, refs) {
  var callback = React.useCallback(function (event) {
...
var usePopper = (function () {
  ...
  var combinedOptions = React.useMemo(function () {
...
var useId = 'useId';
var maybeReactUseId = React__namespace["".concat(useId)];
...
var EzProviderContext = React.createContext(null);
React.forwardRef(function EzProvider(_ref, ref) {
  var theme = _ref.theme,
      children = _ref.children;
  return React__default["default"].createElement(EzProviderContext.Provider, {
...
var PortalContext = React__default["default"].createContext({
  current: null
});
...
var EzPortal = function EzPortal(_ref) {
  ...
  var _useContext = React.useContext(PortalContext),
      contextValue = _useContext.current;

  var contextRef = React.useRef(contextValue);
  ...
  var stitchesClassName = React.useContext(EzProviderContext);
  React.useLayoutEffect(function () {
  ...
  if (!hostNode) return React__default["default"].createElement("div", {
    ref: mountNode
  });
  ...
  }, ReactDOM.createPortal(children, hostNode));
};
...
var useLayoutEffect = typeof window !== 'undefined' ? React__default["default"].useLayoutEffect : function () {};
var activeScope = null;
var scopes = new Set();
var FocusScope = React__default["default"].forwardRef(function FocusScope(props, ref) {
  var children = props.children,
...
var EzPopover = function EzPopover(props) {
  return React__default["default"].createElement(EzPortal$1, null, React__default["default"].createElement(PopoverImpl, props));
};
...
var PopoverImpl = function PopoverImpl(_ref) {
  ...
  var scopeRef = React__default["default"].useRef();
  ...
  }), React__default["default"].createElement(PortalContext.Provider, {
    value: popper
  }, React__default["default"].createElement(FocusScope, {
    restoreFocus: true,
    ref: scopeRef
  }, children)));
};
...
var EzTooltip = function EzTooltip(_ref) {
  ...
  var onShowTooltipRef = React.useRef(onShowTooltip);
  ...
  return React__default["default"].createElement(React__default["default"].Fragment, null, React__default["default"].cloneElement(child, childProps), showTooltip && React__default["default"].createElement(EzPopover$1, {
    targetRef: targetRef,
...
var EzButtonLegacy = React.forwardRef(function (_ref, ref) {
  ...
  var buttonElement = React__default["default"].createElement("button", _extends({
    type: "button"
  }, additionalProps, {
    ...
    ref: ref
  }), props.use === 'tertiary' && props.icon ? React__default["default"].createElement("span", {
    className: icon()
  }, React.cloneElement(props.icon, {
    'aria-hidden': true,
    focusable: false
  }), props.children && React__default["default"].createElement("span", null, props.children)) : props.children);

  if (props.disabled && props.disabledMessage) {
    buttonElement = React__default["default"].createElement(EzTooltip$1, {
  ...
  return React__default["default"].createElement(React__default["default"].Fragment, null, buttonElement);
});
...
var EzButtonMui = React.forwardRef(function (_ref, ref) {
  ...
  return React__default["default"].createElement(ButtonComponent, _extends({
    ref: ref,
  ...
  }, props), React__default["default"].createElement(Box$1, {
    whiteSpace: "nowrap"
  }, children));
});
...
var EzButton = React.forwardRef(function (props, ref) {
  if (props.legacy === true) {
    props.legacy;
        var remainingProps = _objectWithoutProperties(props, _excluded$4);

    return React__default["default"].createElement(EzButtonLegacy$1, _extends({
      ref: ref
    }, remainingProps));
  }
  ...
  return React__default["default"].createElement(EzButtonMui$1, _extends({
    ref: ref,
...
var _excluded$3 = ["element", "slot"],
    _excluded2 = ["children"];
var Slot = React.forwardRef(function Slot(props, ref) {
  ...
  return React__default["default"].createElement(Element, _extends({}, otherProps, {
    ref: ref
  }), React__default["default"].createElement(ClearSlots, null, children));
});
var Slot$1 = Slot;
...
var EzLayout = function EzLayout(_ref) {
  ...
  return React__default["default"].createElement("div", domProps(_objectSpread$2(_objectSpread$2({}, props), {}, {
    className: className
  }), box$1()), React__default["default"].createElement("div", {
...
function Content(props, ref) {
  return React__default["default"].createElement(Slot$1, _extends({
    element: "section",
    slot: "content",
    ref: ref
  }, props));
...
var EzContent = React.forwardRef(Content);
...
var EzHeader = React.forwardRef(Header);
...
var EzFooter = React.forwardRef(Footer);
...
var EzPreview = React.forwardRef(Preview);
...
var EzCardHeading = function EzCardHeading(_ref) {
  ...
  var heading = title && React__default["default"].createElement(EzLayout$1, {
    layout: "basic",
    alignY: "top"
  }, titleIcon, React__default["default"].createElement(EzHeading$1, {
    size: "3",
    subheading: subtitle
  }, title));
  var layout = actions && React__default["default"].createElement(EzLayout$1, {
    layout: "cluster",
    css: {
      justifyContent: 'space-between',
      alignItems: 'baseline'
    }
  }, React__default["default"].createElement("div", null, heading), React__default["default"].createElement("div", null, actions));
...
var EzCardSection = function EzCardSection(_ref) {
  ...
  var content = React__default["default"].createElement(EzContent$1, spacing(props).props, children);
  return React__default["default"].createElement(React__default["default"].Fragment, null, !title ? content : React__default["default"].createElement("section", null, React__default["default"].createElement(EzHeader$1, null, React__default["default"].createElement(EzCardHeading$1, {
    actions: actions,
    title: title,
    subtitle: subtitle
  })), content));
...
var EzCard = function EzCard(_ref) {
  ...
  return React__default["default"].createElement("section", _extends({}, filterValidProps(props), {
  ...
  }), React__default["default"].createElement(SlotProvider, {
    slots: {
      preview: {
        className: preview({
  ...
  }, imageSrc && React__default["default"].createElement(EzPreview$1, null, React__default["default"].createElement("img", {
    src: imageSrc,
    alt: "",
    style: {
      maxHeight: maxHeight,
  ...
  })), title && React__default["default"].createElement(EzHeader$1, null, React__default["default"].createElement(EzCardHeading$1, {
    actions: actions,
    title: title,
    subtitle: subtitle,
    titleIcon: titleIcon
  })), hasContentSlot(children) ? children : React__default["default"].createElement("div", {
    className: clsx(sections(), orientation({
      layout: isHorizontal ? 'horizontal' : 'vertical'
    }))
  }, hasCardSection(children) ? children : React__default["default"].createElement(EzCardSection$1, null, children)), expandable && React__default["default"].createElement(EzFooter$1, null, React__default["default"].createElement(EzButton$1, {
    variant: "text",
...
var Button = function (_a) {
    ...
    return React__default["default"].createElement(EzButton$1, { onClick: onClick },
        " ",
        text);
};
...
var RecipePreview = function (_a) {
    ...
    return React__default["default"].createElement(EzCard$1, { title: recipe.title, subtitle: "Prep time: ".concat(recipe.prep_times.for_2, "mins"), imageSrc: ((_b = recipe.media.images) === null || _b === void 0 ? void 0 : _b.length) ? recipe.media.images[0].image : undefined, imageMaxHeight: 120, size: 'small' },
